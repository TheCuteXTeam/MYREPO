...
OWNER_USERNAME = getenv("OWNER_USERNAME","Itx_prince_king")
CHAT_GROUP = getenv("CHAT_GROUP","https://t.me/best_friends_chatting_Group0")
OWNER_ID = int(getenv("OWNER_ID", None ))
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO","https://github.com/TheCuteXTeam/KidMusicBotRepo",)
...
PROMO = getenv("PROMO","https://telegra.ph/file/717be3d3ecd3d88b4f615.jpg")
